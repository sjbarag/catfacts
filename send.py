...
def stop_generator(size=10):
	return ''.join(random.choice(string.ascii_uppercase + string.digits) for x in range(size))

facts = [
	"""The cat was seen as a sacred animal in ancient Eqypt, and the history of domestic cats dates back to as early as 8000 years.""",
	...
	"""Cats have 220\xc2 field of view where humans only have 180\xc2.""",
	...
	"""Cats have a body temperature of between 101 and 102.2 \xc2F (38 and 39 \xc2C).""",
	...
	"""Cats spend 8 to 50 percent of their day grooming themselves.""",
	...
	"""Wet cat food is highly recommended by scientists, because of the water intake.""",
	"""Cats' ears can hear up to 2 octaves higher than our ears, or 60 to 80 Kilohertz.""",
	"""Cats move their tail as a communication sequence.""",
	"""Cats have a righting gland in their bodies which makes them able to spin in the air, almost always landing on their feet.""",
	"""Cats usually like to eat small servings multiple times a day.""",
	"""Cats need 3 or 4 times the nutritional serving than humans do.""",
	"""As cats age, their sense of smell and taste start to fade.""",
	"""Although it is stereotyped that cats love milk, it has a high chance of giving them severe diarrhea.""",
	"""Cats cannot see in complete and total darkness, but have nocturnal eyes. This is one of the reasons cats eyes shine in the dark.""",
	"""Cats have a higher threshold for heat than we do, at 52 degrees Celcius.""",
	"""Cats' eyes and noses are sensitive to the smell of citrus, making their eyes water and nose run.""",
	"""Cats purr when they are in pain as well as happy.""",
	"""Cats only sweat through their paws.""",
	"""The word "Ailurophilia" (AYL-oo-ro-PHIL-ee-ah)means "To have a love of cats".""",
	"""Cats are descendants of desert animals, so they are not driven to drink water.""",
	"""Cats cannot taste sweetness whatsoever.""",
	"""Cats have 52 vertabrae, twice as much as the amount of vertabrae in our bodies.""",
	"""The third eyelid, also known as the nictitating membrane or haw, slides over the eye when a cat is sick.""",
	"""Cats use their sense of smell, hearing, and sight all at once for hunting.""",
